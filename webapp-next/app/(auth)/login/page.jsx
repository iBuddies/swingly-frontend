  ...
  return (
    <div className="flex flex-col max-w-[480px] w-full gap-8 p-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a className="text-gray-500 text-sm self-end underline hover:text-gray-800" href="#">Forgot Password?</a>
      </div>
      <div className="flex flex-col gap-4">
        <Link href="/library" className="flex items-center justify-center h-12 px-6 rounded-lg font-semibold text-white bg-gray-900 hover:bg-gray-800">Log In</Link>
      ...
      <p className="text-center text-sm text-gray-500">Don't have an account? <Link className="font-semibold text-gray-800 hover:underline" href="/signup">Sign Up</Link></p>
    </div>
  )
}
