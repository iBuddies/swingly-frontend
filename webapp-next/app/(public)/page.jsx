      ...
      <div className="w-full max-w-4xl px-4">
        <section className="text-center py-20 sm:py-28">
          <div className="flex flex-col items-center gap-6">
            ...
            <Link href="/signup" className="flex min-w-[84px] max-w-[480px] items-center justify-center rounded-lg h-12 px-6 bg-primary text-white text-base font-bold tracking-wide hover:opacity-90">Get Your Free Analysis</Link>
          </div>
        </section>
