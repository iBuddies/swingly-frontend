  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white text-gray-800 font-display">
      <div className="flex flex-col max-w-[480px] w-full gap-8 p-8">
        ...
        <div className="flex flex-col gap-4">
          <Link to="/library" className="flex items-center justify-center h-12 px-6 rounded-lg font-semibold text-white bg-primary hover:opacity-90">Create Account</Link>
        </div>
        <p className="text-center text-sm text-gray-500">Already have an account? <Link className="font-semibold text-gray-800 hover:underline" to="/login">Log In</Link></p>
      </div>
    </div>
  )
}
